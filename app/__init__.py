        ...
        'work_experiences': [
            {
                ...
                'responsibilities': [
                    ...
                    'Completed a 12-week SRE curriculum, supplemented with events and workshops by Meta engineers'
                ]
            },
            {
                'title': 'Tech Fellow',
                ...
                'end_date': 'Aug 2024',
                'responsibilities': [
                    'Answered 100+ technical questions on Slack and during breakout sessions',
                    'Taught in 30+ breakout room sessions and encouraging the use of the UMPIRE method, resulting in a 70% improvement in problem-solving efficiency'
                ]
            }
        ],
        'hobby': 'Hobbies',
        ...
        'education_entries': [
            {
                ...
                'details': 'Relevant Coursework: Data Structures and Algorithms, Discrete Math, Computer Architecture, Operating Systems, Software Engineering'
            }
        ],
        'places': 'Places',
    }
...
def index():
    return render_template('index.html', title="MLH Fellow",about="About Yourself",work="Work Experience", hobby="Hobbies", education="Education",places="Places", url=os.getenv("URL"))
